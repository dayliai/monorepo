      ...
      >
        ...
        <div className="mx-6 mt-2 mb-4 flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
          {solution.cover_image_url ? (
            ...
            <div className="w-20 h-20 rounded-xl bg-gray-200 flex-shrink-0 flex items-center justify-center">
          ...
          <div className="min-w-0">
            ...
            {solution.sourceName && (
              <p className="text-xs text-gray-500 mt-1">{solution.sourceName}</p>
            )}
          </div>
        </div>
