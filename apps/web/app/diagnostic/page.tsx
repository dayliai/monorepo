...
const CARE_OPTIONS = [
  { id: 'therapy', title: 'Yes, therapy', desc: 'Such as physical, occupational, or speech therapy', icon: Activity },
  { id: 'home', title: 'Yes, home care', desc: 'Assistance with daily living activities at home', icon: Home },
...
const CATEGORIES = [
  { id: 'mobility', title: 'Mobility & Movement', icon: Activity },
