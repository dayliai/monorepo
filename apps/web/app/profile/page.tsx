...
export default function ProfilePage() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-[#fdfafb] font-sans">
      ...
      {/* Content */}
      <main id="main-content" tabIndex={-1} className="flex-1 overflow-y-auto px-6 py-8 md:py-12 focus:outline-none">
        <div className="mx-auto w-full max-w-3xl space-y-10 md:space-y-12">

          {/* Avatar Header Section */}
          <div className="flex flex-col items-center max-w-full">
            <div className="relative mb-4">
              <div className="flex h-[104px] w-[104px] md:h-[120px] md:w-[120px] items-center justify-center overflow-hidden rounded-full border-4 border-white bg-gray-100 shadow-[0px_8px_24px_0px_rgba(74,21,75,0.12)]" aria-hidden="true">
                <User className="h-full w-full p-5 text-gray-500" />
              </div>
              <button
                type="button"
              ...
              >
                <Camera className="h-4 w-4 md:h-5 md:w-5" aria-hidden="true" />
              </button>
            </div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between rounded-[16px] border-2 border-gray-100 bg-gray-50 p-4">
                  <div className="flex flex-1 min-w-0 items-center gap-3 pr-4">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white text-gray-700 shadow-sm" aria-hidden="true">
            ...
            <div className="overflow-hidden rounded-[24px] md:rounded-[32px] bg-white shadow-[0px_8px_24px_0px_rgba(0,0,0,0.02)] border border-gray-100">
              ...
              <div className="flex items-center justify-between p-6 md:p-8">
                <div className="flex items-center gap-4">
                  <div className="flex h-12 w-12 md:h-14 md:w-14 items-center justify-center rounded-full bg-gray-100 text-gray-700" aria-hidden="true">
                    <Type className="h-6 w-6 md:h-7 md:w-7" />
                  </div>
                  <div>
                    <span id="large-text-label" className="block text-[16px] md:text-[18px] font-bold text-[#121928]">Larger Text</span>
                    <span id="large-text-desc" className="block text-[14px] md:text-[15px] text-[#6a7282]">Increase text size across the app</span>
                  </div>
                </div>
                <button
                  type="button"
                  ...
                  className={`relative inline-flex h-8 w-14 items-center rounded-full transition-colors ${
                    largeText ? 'bg-[#06b6d4]' : 'bg-gray-400'
                  }`}
                >
                  <span
                    aria-hidden="true"
          ...
          <section>
            ...
            <div className="overflow-hidden rounded-[24px] md:rounded-[32px] bg-white shadow-[0px_8px_24px_0px_rgba(0,0,0,0.02)] border border-gray-100 mb-6">
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="flex h-12 w-12 md:h-14 md:w-14 items-center justify-center rounded-full bg-red-50 text-red-700 group-hover:bg-red-100 transition-colors" aria-hidden="true">
                    <LogOut className="h-6 w-6 md:h-7 md:w-7" />
                  </div>
                  <div>
                    <span className="block text-[16px] md:text-[18px] font-bold text-red-700">Sign Out</span>
                    <span className="block text-[14px] md:text-[15px] text-red-700">Log out of your account on this device</span>
                  </div>
                </div>
                <ChevronRight className="h-6 w-6 text-red-700" aria-hidden="true" />
              </button>
            </div>
            ...
            <div className="overflow-hidden rounded-[24px] md:rounded-[32px] bg-white shadow-[0px_8px_24px_0px_rgba(0,0,0,0.02)] border border-gray-100">
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="flex h-12 w-12 md:h-14 md:w-14 items-center justify-center rounded-full bg-red-100 text-red-700 group-hover:bg-red-200 transition-colors" aria-hidden="true">
                    <Trash2 className="h-6 w-6 md:h-7 md:w-7" />
                  </div>
                  <div>
                    <span className="block text-[16px] md:text-[18px] font-bold text-red-700">Delete Account</span>
                    <span className="block text-[14px] md:text-[15px] text-red-700">Permanently remove your data</span>
                  </div>
                </div>
              </button>
            </div>
      ...
      {isUsernameModalOpen && (
        <div className="fixed inset-0 z-50 flex flex-col justify-end md:justify-center md:items-center md:p-6">
          ...
          />
          <div role="dialog" aria-modal="true" className="relative flex w-full md:max-w-md flex-col rounded-t-[32px] md:rounded-[32px] bg-white shadow-2xl p-8 md:p-10">
            <div className="mx-auto mb-8 h-1.5 w-16 rounded-full bg-gray-300 md:hidden" />
            <button
              onClick={() => setIsUsernameModalOpen(false)}
              type="button"
              aria-label="Close dialog"
              className="absolute right-6 top-6 flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-gray-700 transition-colors hover:bg-gray-200"
            >
            ...
            <label htmlFor="profile-username" className="mb-3 block text-[15px] font-bold text-[#121928]">
              New Username
            </label>
            <input
              id="profile-username"
            ...
            <button
              ...
              className="flex h-14 w-full items-center justify-center rounded-full bg-[#4A154B] text-[18px] font-bold text-white transition-all hover:bg-[#310D32] active:scale-[0.98] disabled:bg-gray-200 disabled:text-gray-700 disabled:transform-none"
            >
              Save Username
            </button>
          </div>
      ...
      {isResetPasswordOpen && (
        <div className="fixed inset-0 z-50 flex flex-col justify-end md:justify-center md:items-center md:p-6">
          ...
          />
          <div role="dialog" aria-modal="true" className="relative flex w-full md:max-w-lg flex-col rounded-t-[32px] md:rounded-[32px] bg-white shadow-2xl p-8 md:p-10">
            <div className="mx-auto mb-8 h-1.5 w-16 rounded-full bg-gray-300 md:hidden" />
            <button
              onClick={() => { setIsResetPasswordOpen(false); setIsResetSuccess(false) }}
              type="button"
      ...
      {isDeleteAccountOpen && (
        <div className="fixed inset-0 z-50 flex flex-col justify-end md:justify-center md:items-center md:p-6">
          ...
          <div role="dialog" aria-modal="true" className="relative flex w-full md:max-w-lg flex-col rounded-t-[32px] md:rounded-[32px] bg-white shadow-2xl p-8 md:p-10">
            ...
            <label htmlFor="profile-delete-confirm" className="mb-3 block text-[15px] font-bold text-[#121928]">
              Type <span className="text-[#B91C1C] font-mono bg-red-50 px-2 py-1 rounded mx-1">DELETE</span> to confirm
            </label>
            <input
          ...
          <div role="dialog" aria-modal="true" className="relative flex w-full md:max-w-md flex-col rounded-t-[32px] md:rounded-[32px] bg-white shadow-2xl p-8 md:p-10">
            ...
            {emailSuccess ? (
              ...
              <>
                ...
                <label htmlFor="profile-email" className="mb-3 block text-[15px] font-bold text-[#121928]">
                  New Email Address
                </label>
                <input
                  id="profile-email"
                ...
                {emailError && (
                  <p role="alert" className="mb-4 text-[14px] text-[#B91C1C] bg-red-50 rounded-xl px-4 py-3">
