        ...
        <div className="text-[#461F65]/80 leading-relaxed space-y-6 text-[15px]">
          <section>
            ...
            <p>
              ...
              or by mail to: Daily Living Labs, 6057 Preston Haven Dr, Dallas, TX 75230, United States.
            </p>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">Table of Contents</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">1. Our Services</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">2. Intellectual Property Rights</h2>
            <h3 className="font-semibold text-[#461F65] mt-4 mb-1">Our intellectual property</h3>
            <p>
            ...
            <h3 className="font-semibold text-[#461F65] mt-4 mb-1">Your use of our Services</h3>
            ...
            <h3 className="font-semibold text-[#461F65] mt-4 mb-1">Your submissions</h3>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">3. User Representations</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">4. Prohibited Activities</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">5. User Generated Contributions</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">6. Contribution License</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">7. Services Management</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">8. Term and Termination</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">9. Modifications and Interruptions</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">10. Governing Law</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">11. Dispute Resolution</h2>
            <h3 className="font-semibold text-[#461F65] mt-4 mb-1">Informal Negotiations</h3>
            ...
            <h3 className="font-semibold text-[#461F65] mt-4 mb-1">Binding Arbitration</h3>
            ...
            <h3 className="font-semibold text-[#461F65] mt-4 mb-1">Restrictions</h3>
            ...
            <h3 className="font-semibold text-[#461F65] mt-4 mb-1">Exceptions to Informal Negotiations and Arbitration</h3>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">12. Corrections</h2>
            <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>
          </section>

          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">13. Disclaimer</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">14. Limitations of Liability</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">15. Indemnification</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">16. User Data</h2>
            <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>
          </section>

          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">17. Electronic Communications, Transactions, and Signatures</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">18. Miscellaneous</h2>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-[#461F65] mb-2">19. Contact Us</h2>
