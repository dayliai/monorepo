    ...
    <div className="flex min-h-screen w-full flex-col font-sans bg-white">
      ...
      <main id="main-content" tabIndex={-1} className="flex-1 max-w-3xl mx-auto w-full px-4 py-12 focus:outline-none">
        ...
        <div className="text-[#461F65]/80 leading-[1.7] text-[15px] space-y-10 [&_section]:space-y-3">
          ...
          <section>
            <h2 className="font-serif text-2xl font-bold text-[#461F65] mb-3 pb-2 border-b border-[#461F65]/10">No Medical Advice</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl font-bold text-[#461F65] mb-3 pb-2 border-b border-[#461F65]/10">Third-Party Content and External Links</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl font-bold text-[#461F65] mb-3 pb-2 border-b border-[#461F65]/10">Accessibility of Third-Party Content</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl font-bold text-[#461F65] mb-3 pb-2 border-b border-[#461F65]/10">AI-Generated Content</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl font-bold text-[#461F65] mb-3 pb-2 border-b border-[#461F65]/10">User Responsibility</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl font-bold text-[#461F65] mb-3 pb-2 border-b border-[#461F65]/10">Limitation of Liability</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl font-bold text-[#461F65] mb-3 pb-2 border-b border-[#461F65]/10">Contact</h2>
