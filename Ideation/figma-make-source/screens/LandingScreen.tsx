...
import imgImageDayliAiLogotype from "figma:asset/dbfdd24d7e086adb894952b4b87cdf550fcd9843.png";
import imgButterfly from "figma:asset/e4c89b3dd58c82651d27c102c5b7d3f72ec6058d.png";
    ...
    <div className="flex min-h-screen w-full flex-col font-sans bg-white overflow-x-hidden">
      ...
      <header className="flex h-[72px] shrink-0 items-center justify-between border-b border-gray-100 bg-white/80 px-6 md:px-12 backdrop-blur-md sticky top-0 z-50">
        <button onClick={() => navigate('/')} className="transition-transform hover:scale-105">
          <img src={imgImageDayliAiLogotype} alt="Dayli AI" className="h-6 md:h-8 object-contain" />
        </button>
        <HeaderProfileMenu showText={true} />
      </header>
      ...
      <main className="flex-1 bg-[#fdfafb]">
          ...
          <div className="relative z-10 flex flex-row gap-6 md:gap-12 md:justify-center overflow-x-auto pb-8 snap-x snap-mandatory px-6 md:px-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <div className="snap-center shrink-0 w-[280px] md:w-[320px] h-[360px] md:h-[400px] rounded-[32px] bg-white border-[6px] border-gray-100 shadow-[0px_16px_40px_0px_rgba(0,0,0,0.08)] overflow-hidden flex flex-col transform md:rotate-[-2deg] transition-transform hover:rotate-0">
              ...
              <div className="p-6 flex-1 bg-white">
                <h3 className="font-serif text-[20px] font-bold text-[#121928] mb-5 transition-opacity">What areas do you need support with?</h3>
            ...
            <div className="snap-center shrink-0 w-[280px] md:w-[320px] h-[360px] md:h-[400px] rounded-[32px] bg-white border-[6px] border-gray-100 shadow-[0px_16px_40px_0px_rgba(0,0,0,0.08)] overflow-hidden flex flex-col transform md:rotate-[2deg] md:translate-y-6 transition-transform hover:rotate-0">
              ...
              <div className="p-5 flex-1 flex flex-col justify-end gap-4 bg-[#fdfafb] relative">
                ...
                {/* User Message */}
                {chatStep2 && (
                  <div className="self-end w-full bg-[#4A154B] rounded-[20px] rounded-br-sm p-4 shadow-sm animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                {/* AI Typing Indicator */}
                {chatStep3 && !chatStep4 && (
                  <div className="self-start w-full bg-white border border-gray-100 shadow-sm rounded-[20px] rounded-bl-sm p-4 flex gap-1.5 animate-in fade-in duration-300">
                ...
                {/* AI Response */}
                {chatStep4 && (
                  <div className="self-start w-full bg-white border border-gray-100 shadow-sm rounded-[20px] rounded-bl-sm p-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                    <div className="w-full h-2.5 bg-gray-300 rounded-full mb-2" />
                ...
                {/* Input Area */}
                <div className="h-12 mt-2 w-full rounded-full border-2 border-gray-200 bg-gray-50 flex items-center px-4 gap-3 relative overflow-hidden">
        ...
        <section className="px-6 py-16 md:py-24 text-center bg-[#4A154B] text-white">
          <div className="max-w-3xl mx-auto">
            <button onClick={() => navigate('/')} className="transition-transform hover:scale-105 inline-block">
              <img src={imgButterfly} alt="Butterfly" className="h-40 w-40 md:h-48 md:w-48 object-contain mx-auto mb-8" />
            </button>
        ...
        <section className="px-6 py-16 md:py-24 bg-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto relative z-10 text-center">
            ...
            <button
              onClick={() => navigate('/daily-living-labs')}
        ...
        <section className="px-6 py-16 md:py-24 bg-gray-50 border-t border-gray-100">
          <div className="max-w-2xl mx-auto">
            <div className="rounded-[32px] md:rounded-[40px] bg-white p-8 md:p-12 shadow-[0px_8px_24px_0px_rgba(0,0,0,0.04)] border border-gray-100">
              ...
              {isSubmitted ? (
                <div className="rounded-[24px] bg-[#F3E8F4] p-8 text-center animate-in zoom-in duration-300">
      ...
      <footer className="bg-white border-t border-gray-100 px-6 py-12 md:py-16 text-center">
        <button onClick={() => navigate('/')}>
          <img src={imgImageDayliAiLogotype} alt="Dayli AI" className="h-6 object-contain mx-auto mb-6 opacity-40 grayscale transition-opacity hover:opacity-80" />
        </button>
        ...
        <div className="flex justify-center gap-6 text-[14px] text-gray-500 font-medium">
          ...
          <span>•</span>
          <span className="cursor-pointer hover:text-[#4A154B] transition-colors">Terms of Service</span>
        </div>
      </footer>
    </div>
  );
